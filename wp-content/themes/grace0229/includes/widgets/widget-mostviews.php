				...
				while ( $hot_posts->have_posts() ) :
					...
					<li>
						<a class="img" href="<?php the_permalink(); ?>"	title="<?php the_title(); ?>">
							...
							<div class="title">
								<div class="entry-meta"><span><i class="icon-eye"></i> <?php if(function_exists('the_views')){the_views(); }//post_views('',''); ?></span><span><i class="icon-calendar-1"></i> <?php the_time('Y-n-j') ?></span></div>
