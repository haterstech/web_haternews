<?php
/**
 * Twitter embed script Compatibility.
 *
 * @since 1.3.2
 * @package wp-native-articles
 */

if ( ! function_exists( 'wpna_transform_embed_twitter' ) ) :
	 ...
	 */
	function wpna_transform_embed_twitter( $dom_document ) {
		...
		while ( $i > -1 ) {
			...
			if ( 'twitter-tweet' === $node->getAttribute( 'class' ) ) {
				...
				$script_template->setAttribute( 'src', 'https://platform.twitter.com/widgets.js' );
...
add_filter( 'wpna_facebook_article_content_transform', 'wpna_transform_embed_twitter', 5, 1 );
